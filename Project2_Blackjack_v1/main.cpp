 ...
 * Purpose: Updated version of Project 1 v5 where 
 *          functions and return function are implemented
 */
...
int Rate(){     //Rate the game 
    ...
    cout << "Thank you for rating this program! Hope you enjoy your visit!" << endl;
